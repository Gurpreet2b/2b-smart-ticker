...
export class CreateSurveyComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.authService.SetRestaurantName(`Create Feedback Alert`);
  ...
  IsSurveyScript() {
    ...
    document.getElementById("header-Survey-img").innerHTML = `<img src="${this.HeaderTextImg}" alt="Logo" width="70px">`;
